...
/* EP2  */
#define ENDP2_RXADDR0       (0x140)
#define ENDP2_RXADDR1       (0x180)

/* EP3  */
#define ENDP3_TXADDR0       (0x1C0)
#define ENDP3_TXADDR1       (0x200)
...
#define IMR_MSK (CNTR_CTRM  | CNTR_RESETM | CNTR_SUSPM | CNTR_WKUPM )
